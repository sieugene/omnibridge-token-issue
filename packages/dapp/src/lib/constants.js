...
export const HOME_CHAIN = Number(process.env.REACT_APP_HOME_CHAINID);
export const FOREIGN_CHAIN = Number(process.env.REACT_APP_FOREIGN_CHAINID);
...
export const HOME_FOREIGN_BRIDGE = "home-foreign";
...
export const networkNames = {
  ...
  99: "POA Network",
  100: "Gnosis Chain",
  [HOME_CHAIN]: "Home network",
  [FOREIGN_CHAIN]: "Foreign network",
};
...
export const chainUrls = {
  ...
  [HOME_CHAIN]: {
    rpc: REACT_APP_HOME_RPC.split(" "),
    explorer: process.env.REACT_APP_HOME_EXPLORER,
    chainId: HOME_CHAIN,
    name: networkNames[HOME_CHAIN],
  },
  [FOREIGN_CHAIN]: {
    rpc: REACT_APP_FOREIGN_RPC.split(" "),
    explorer: process.env.REACT_APP_FOREIGN_EXPLORER,
    chainId: FOREIGN_CHAIN,
    name: networkNames[FOREIGN_CHAIN],
  },
};
...
export const LOCAL_STORAGE_KEYS = {
  ...
  HOME_RPC_URL: "home-rpc-url",
  FOREIGN_RPC_URL: "foreign-rpc-url",
