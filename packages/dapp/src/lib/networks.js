...
const HOME_FOREIGN_BRIDGE_CONFIG = {
  label: "home⥊foreign",
  homeChainId: HOME_CHAIN,
  foreignChainId: FOREIGN_CHAIN,
  enableForeignCurrencyBridge: false,
  foreignMediatorAddress: process.env.REACT_APP_FOREIGN_MEDIATOR.toLowerCase(),
  homeMediatorAddress: process.env.REACT_APP_HOME_MEDIATOR.toLowerCase(),
  foreignAmbAddress: process.env.REACT_APP_FOREIGN_AMB.toLowerCase(),
  homeAmbAddress: process.env.REACT_APP_HOME_AMB.toLowerCase(),
  foreignGraphName: "dan13ram/mainnet-to-bsc-omnibridge",
  homeGraphName: "dan13ram/bsc-to-mainnet-omnibridge",
  ambLiveMonitorPrefix: "http://alm-bsc.herokuapp.com",
  claimDisabled: false,
...
const bridgeInfo = {
  ...
  [HOME_FOREIGN_BRIDGE]: HOME_FOREIGN_BRIDGE_CONFIG,
};
...
export const defaultTokens = {
  ...
  [HOME_FOREIGN_BRIDGE]: {
    [HOME_CHAIN]: {
      address: process.env.REACT_APP_HOME_TOKEN,
      chainId: HOME_CHAIN,
      symbol: "Home token",
      name: "Home token",
    },
    [FOREIGN_CHAIN]: {
      address: process.env.REACT_APP_FOREIGN_TOKEN,
